...
class SearchHotelsInputModel(BaseModel):
    city: str = Field(
        ...,
        description="City the user would like to look for a hotel at.",
    )
    checkin_date: List[str] = Field(
        ...,
